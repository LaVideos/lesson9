...
//             parts.innerHTML = `${it} - ${item[it]}`
//         }else {
//             for (const i in item[it]) {
//                 const el = document.createElement('div');
//                 if(typeof item[it][i] !== 'object'){
//                     el.innerHTML = `${i} - ${item[it][i]}`;
//                 }else {
//                     for (const a in item[it][i]) {
//                         const al = document.createElement('div');
//                         al.innerHTML = `${a} - ${item[it][i][a]}`
//                         el.append(al);
//                     }
//
//                 }
...
//
// contenteditable.innerHTML = 'some';
//
// let a = contenteditable.innerText;
//
